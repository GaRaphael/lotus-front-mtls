...
const SelectBoots = forwardRef<HTMLSelectElement, ISelectProps>(
	(
		{
			id,
			name,
...
SelectBoots.displayName = 'Select';
SelectBoots.propTypes = {
	id: PropTypes.string,
